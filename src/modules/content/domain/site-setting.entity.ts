...
export enum SettingKey {
  ...
  /** 배너 이미지 슬롯 — 언어별 분리, JSON 배열 [{imageUrl,linkUrl},...] 로 저장 */
  BANNER_BEGINNER_IMAGES_KO = 'banner_beginner_images_ko',
  BANNER_BEGINNER_IMAGES_EN = 'banner_beginner_images_en',
  BANNER_SUPPLY_IMAGES_KO = 'banner_supply_images_ko',
  BANNER_SUPPLY_IMAGES_EN = 'banner_supply_images_en',
  BANNER_BOOTH_IMAGES_KO = 'banner_booth_images_ko',
  BANNER_BOOTH_IMAGES_EN = 'banner_booth_images_en',
  BANNER_MEDIA_IMAGES_KO = 'banner_media_images_ko',
  BANNER_MEDIA_IMAGES_EN = 'banner_media_images_en',
  BANNER_AD_IMAGES_KO = 'banner_ad_images_ko',
  BANNER_AD_IMAGES_EN = 'banner_ad_images_en',
  BANNER_PARTNER_IMAGES_KO = 'banner_partner_images_ko',
  BANNER_PARTNER_IMAGES_EN = 'banner_partner_images_en',
}
...
export const SETTING_DEFAULTS: Record<SettingKey, string> = {
  ...
  [SettingKey.BANNER_BEGINNER_IMAGES_KO]: '[]',
  [SettingKey.BANNER_BEGINNER_IMAGES_EN]: '[]',
  [SettingKey.BANNER_SUPPLY_IMAGES_KO]: '[]',
  [SettingKey.BANNER_SUPPLY_IMAGES_EN]: '[]',
  [SettingKey.BANNER_BOOTH_IMAGES_KO]: '[]',
  [SettingKey.BANNER_BOOTH_IMAGES_EN]: '[]',
  [SettingKey.BANNER_MEDIA_IMAGES_KO]: '[]',
  [SettingKey.BANNER_MEDIA_IMAGES_EN]: '[]',
  [SettingKey.BANNER_AD_IMAGES_KO]: '[]',
  [SettingKey.BANNER_AD_IMAGES_EN]: '[]',
  [SettingKey.BANNER_PARTNER_IMAGES_KO]: '[]',
  [SettingKey.BANNER_PARTNER_IMAGES_EN]: '[]',
};
